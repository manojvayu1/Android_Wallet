...
public class ProductTourActivity extends AppCompatActivity {
    ...
    private void endTutorial(){
        startActivity(new Intent(ProductTourActivity.this,Login_Activity.class));
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = ProductTourFragment.newInstance(R.layout.activity_tour1);
                    break;
                case 1:
                    tp = ProductTourFragment.newInstance(R.layout.activity_tour2);
                    break;
                case 2:
                    tp = ProductTourFragment.newInstance(R.layout.activity_tour3);
                    break;
                case 3:
                    tp = ProductTourFragment.newInstance(R.layout.activity_tour4);
                    break;
            }
